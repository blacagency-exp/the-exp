  ...
  while (retryCount <= maxRetries) {
    try {
      ...
      if (retryCount > maxRetries) {
        console.error("Error generating signed URL (max retries reached):", error)
      ...
      console.warn(`Error generating signed URL (attempt ${retryCount}/${maxRetries}):`, error)
...
// Add this function to check if a URL is valid and accessible
