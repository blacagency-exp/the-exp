...
export function ExperienceGrid() {
  const GridContent = () => (
    <div className="hidden md:block flex-shrink-0 px-1">
      <div className="grid grid-cols-[1fr_1fr_1.6fr_1fr] gap-2 h-[300px] lg:h-[478px]">
  ...
  const MobileContent = () => (
    <div className="flex md:hidden gap-3 px-4 pb-4 overflow-x-auto snap-x snap-mandatory">
      {[img4, img5, img1, img2, img3, img6].map((img, index) => (
        <div key={index} className="flex-none w-[280px] h-[200px] relative rounded-3xl overflow-hidden snap-center">
